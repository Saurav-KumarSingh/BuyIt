        ...
        <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <textarea name="description" value={productData.description} onChange={handleChange} className='w-full border border-gray-300 rounded-md py-2' rows={4} required />
                </div>
                {/* Price */}
                <div className="mb-6">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className="w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:border-indigo-500"
                    />
                </div>
                {/* Count in Stock  */}
                <div className="mb-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex gap-4 mt-4">
                        {productData.images.map((image, index) => (<div key={index}>
