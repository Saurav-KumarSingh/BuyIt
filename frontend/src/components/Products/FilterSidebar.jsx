...
const FilterSidebar = () => {
    ...
    const brands = ["Urban Threads", "Modern Fit", "Street Style", "Beach Breexe", "Fashioninsta", "ChicStyle"];
    ...
    useEffect(() => {
        ...
        const max = +params.maxPrice || 1000;
    ...
    const updateURLParams = (newFilters) => {
        ...
        navigate(`?${params.toString()}`); // ✅ FIXED: properly calling toString()
    };
            ...
            <div className="mb-8">
                ...
                <input
                    ...
                    onChange={(e) => {
                        ...
                        const updated = { ...filters, maxPrice: value };
                        setFilters(updated);
                        updateURLParams(updated);
                    }}
