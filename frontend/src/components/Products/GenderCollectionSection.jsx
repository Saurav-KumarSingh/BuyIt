...
import mensCollectionImg from '../../assets/mens-collections.webp';
import womensCollectionImg from '../../assets/girl-collection.webp';
...
const GenderCollectionSection = () => {
  return (
    <section className='py-16 px-4 lg:px-10'>
        <div className='coontainer mx-auto flex flex-col md:flex-row gap-8 md:gap-12'>
            {/* women's collection */}
