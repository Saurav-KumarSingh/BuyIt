   ...
   <section className='py-16 px-4 lg:px-10'>
        <div className='container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl'>
            <div className='lg:w-1/2 p-8 text-center lg:text-left '>
                ...
                <Link to="collections/all" className='bg-black text-white px-6
            ...
            <img src={featuredImage} alt="Featured Collection" className='w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl '/></div>
        </div>
   </section>
  )
}
